(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-restaurant-store-store-module"], {
    /***/
    "BNOO":
    /*!************************************************!*\
      !*** ./src/app/views/restaurant/store/pipe.ts ***!
      \************************************************/

    /*! exports provided: searchPipe2 */

    /***/
    function BNOO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "Hp8H":
    /*!***************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/restaurant/store/store.component.html ***!
      \***************************************************************************************************/

    /*! exports provided: default */

    /***/
    function Hp8H(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "QXia":
    /*!****************************************************************!*\
      !*** ./src/app/views/restaurant/store/store-routing.module.ts ***!
      \****************************************************************/

    /*! exports provided: storeRoutingModule */

    /***/
    function QXia(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "Rr81":
    /*!********************************************************!*\
      !*** ./src/app/views/restaurant/store/store.module.ts ***!
      \********************************************************/

    /*! exports provided: StoreModule */

    /***/
    function Rr81(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "ZLJR":
    /*!***********************************************************!*\
      !*** ./src/app/views/restaurant/store/store.component.ts ***!
      \***********************************************************/

    /*! exports provided: StoreComponent */

    /***/
    function ZLJR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var StoreComponent = /*#__PURE__*/function () {
        function StoreComponent(db, auth, router) {
          var _this = this;
        ...
        _createClass(StoreComponent, [{
          ...
          value: function modalOpen(key) {
            ...
            this.products.forEach(function (element) {
              if (key == element.key) {
                ...
                _this2.stock = element.payload.val().restaurant1Stock;
                _this2.restaurant1Stocks = element.payload.val().restaurant1Stock;
          ...
          value: function addStock(stock) {
            ...
            this.db.database.ref('/products/' + this.keys).update({
              restaurant1Stock: this.restaurant1Stocks + stock
            });
            this.db.list("/statistics/stock").push({
              process: "Restoran 1 aktarma",
              name: this.name,
              group: this.group,
          ...
          value: function returnStock(stock) {
            ...
            this.products.forEach(function (element) {
              if (_this4.keys == element.key) {
                ...
                _this4.photo = element.payload.val().photo;
                _this4.restaurant1Stocks = element.payload.val().restaurant1Stock;
                _this4.stockDepo = element.payload.val().stock;
              }
            ...
            this.restaurant1Stocks = 0; //this.stock = 0;

            this.largeModal2.hide();
            this.db.list("/statistics/stock").push({
              process: "Restoran 1 iade",
              name: this.name,
              group: this.group,
              date: this.dateString,
              stock: stock,
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_fire_database__WEBPACK_IMPORTED_MODULE_4__["AngularFireDatabase"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_5__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]])], StoreComponent);
      /***/
    }
  }]);
})();
//# sourceMappingURL=views-restaurant-store-store-module-es5.js.map