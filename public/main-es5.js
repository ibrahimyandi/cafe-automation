(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\ibrah\Documents\GitHub\cafe-automation\src\main.ts */
      "zUnb");
      /***/
    },
        ...
        function DefaultLayoutComponent(router, authService, auth) {
          ...
          auth.onAuthStateChanged(function (user) {
            if (user) {
              ...
              if (_this.user.search("cafe") != -1 || _this.user.search("stock") != -1) {
                _nav__WEBPACK_IMPORTED_MODULE_3__["navItems"].splice(0, 1);

                router.navigate(["/stock"]);
              }

              if (_this.user.search("cafe1") != -1) {
                _nav__WEBPACK_IMPORTED_MODULE_3__["navItems"].splice(7, 3);
              }

              if (_this.user.search("cafe2") != -1) {
                _nav__WEBPACK_IMPORTED_MODULE_3__["navItems"].splice(4, 3);
              }

              if (_this.user.search("stock") != -1) {
                _nav__WEBPACK_IMPORTED_MODULE_3__["navItems"].splice(4, 9);
              }
            }
          });
        }
