(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-cafe2-store-store-module"], {
      ...
      var StoreComponent = /*#__PURE__*/function () {
        ...
        _createClass(StoreComponent, [{
          ...
          value: function modalOpen(key) {
            ...
            this.products.forEach(function (element) {
              if (key == element.key) {
                ...
                _this2.stock = element.payload.val().cafe2Stock;
                _this2.cafe2Stocks = element.payload.val().cafe2Stock;
          ...
          value: function addStock(stock) {
            ...
            this.db.database.ref('/products/' + this.keys).update({
              cafe2Stock: this.cafe2Stocks + stock
            });
            this.db.list("/statistics/stock").push({
              process: "Kafe 2 aktarma",
              name: this.name,
              group: this.group,
          ...
          value: function returnStock(stock) {
            ...
            this.products.forEach(function (element) {
              if (_this4.keys == element.key) {
                ...
                _this4.cafe2Stocks = element.payload.val().cafe2Stock;
              }
            ...
            this.cafe2Stocks = 0; //this.stock = 0;

            this.largeModal2.hide(); //this.db.list("/statistics/stock").push({process:"Kafe 2 iade",name:this.name,group:this.group,date:this.dateString,stock:stock,cost:this.cost});
          }
        }]);
    ...
    /***/
    function Et0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function LnKY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function knYl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function mH2g(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=views-cafe2-store-store-module-es5.js.map